...
HTMLCell&
HTMLCell::addAttribute( std::string key, std::string value ) &
{
    attributes_.emplace_back( HTMLAttr( key, value ) );
    return *this;
}
...
HTMLTable&
HTMLTable::addAttribute( std::string key, std::string value) &
{
    attributes_.emplace_back( HTMLAttr( key, value ) );
    return *this;
}
