...
public:
  ...
  struct Entry {
    ...
    void write(std::ostream &os, size_t width = 0) const;
  };
...
private:
  Entry &upsert(std::string_view key);
...
template <typename Derived> class AttributedElement {
protected:
...
public:
  ...
  Derived &setQuoted(std::string_view key, std::string_view value) {
    attributes_.setQuoted(key, value);
    return static_cast<Derived &>(*this);
  }

  Derived &setRaw(std::string_view key, std::string_view value) {
    attributes_.setRaw(key, value);
    return static_cast<Derived &>(*this);
  }

  Derived &setHtml(std::string_view key, std::string_view value) {
    attributes_.setHtml(key, value);
    return static_cast<Derived &>(*this);
  }

  template <typename TNum>
  Derived &setNumber(std::string_view key, TNum value) {
    attributes_.setNumber(key, value);
    return static_cast<Derived &>(*this);
  }

  Derived &setBool(std::string_view key, bool value) {
    attributes_.setBool(key, value);
    return static_cast<Derived &>(*this);
  }

  Derived &setQuotedLabel(std::string_view value) {
    attributes_.setQuotedLabel(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setHtmlLabel(std::string_view value) {
    attributes_.setHtmlLabel(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setColor(std::string_view value) {
    attributes_.setColor(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setFillColor(std::string_view value) {
    attributes_.setFillColor(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setFontColor(std::string_view value) {
    attributes_.setFontColor(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setFontName(std::string_view value) {
    attributes_.setFontName(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setFontSize(std::size_t value) {
    attributes_.setFontSize(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setShape(std::string_view value) {
    attributes_.setShape(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setStyle(std::string_view value) {
    attributes_.setStyle(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setPenWidth(std::size_t value) {
    attributes_.setPenWidth(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setWeight(std::size_t value) {
    attributes_.setWeight(value);
    return static_cast<Derived &>(*this);
  }

  Derived &setConstraint(bool value) {
    attributes_.setConstraint(value);
    return static_cast<Derived &>(*this);
  }

  virtual void write(std::ostream &os, size_t width = 0) const = 0;
};
...
public:
  ...
  void write(std::ostream &os, size_t width = 0) const override;
};
...
public:
  ...
  const std::vector<std::unique_ptr<Subgraph>> &subgraphs() const;
